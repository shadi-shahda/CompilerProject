...
public class TemplatesLexer extends Lexer {
	...
	public static final int
		TAG_MODE=1, ATTRIBUTE_MODE=2, SINGLE_ATTRIBUTE_MODE=3, JINJA_MODE=4;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "TAG_MODE", "ATTRIBUTE_MODE", "SINGLE_ATTRIBUTE_MODE", 
		"JINJA_MODE"
	};
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"TEXT", "TAG_WS", "TAG_EQUALS", "DOUBLE_QUOTE", "SINGLE_QUOTE", "VOID_TAG_ID", 
			"TAG_ID", "TAG_EXIT", "TAG_EXIT_SELF", "ATTR_EXPR_START", "ATTR_TEXT", 
			"ATTR_QUOTE_END", "ATTR_EXPR_START_SINGLE", "ATTR_TEXT_SINGLE", "ATTR_SINGLE_QUOTE_END", 
			"J_WS", "J_IF", "J_ELSE", "J_ENDIF", "J_FOR", "J_ENDFOR", "J_IN", "J_AND", 
			"J_OR", "J_NOT", "J_SET", "J_TRUE", "J_FALSE", "J_BLOCK_CLOSE", "J_EXPR_CLOSE", 
			"J_EQ", "J_NEQ", "PLUS", "MINUS", "MUL", "DIV", "J_LBRACK", "J_RBRACK", 
			"J_DOT", "J_LPAREN", "J_RPAREN", "J_GT", "J_LT", "J_GTE", "J_LTE", "J_STRING", 
			"J_INT", "J_ID", "J_ASSIGN"
		};
	}
