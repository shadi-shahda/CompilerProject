...
public class FlaskPythonParser extends Parser {
	...
	public static final int
		...
		GLOBAL=16, BREAK=17, CONTINUE=18, LBRACE=19, RBRACE=20, LPAREN=21, RPAREN=22, 
		LBRACKET=23, RBRACKET=24, COLON=25, COMMA=26, DOT=27, AT=28, ASSIGN=29, 
		EQUALS=30, NOT_EQUALS=31, PLUS=32, MINUS=33, MUL=34, DIV=35, BLOCK_END=36, 
		ID=37, INT=38, STRING=39, BOOLEAN=40, COMMENT=41, WS=42;
	public static final int
		...
		RULE_breakStmt = 12, RULE_continueStmt = 13, RULE_ifStmt = 14, RULE_condition = 15, 
		RULE_forStmt = 16, RULE_returnStmt = 17, RULE_assignment = 18, RULE_globalStmt = 19, 
		RULE_expressionStmt = 20, RULE_expression = 21, RULE_flaskFunc = 22, RULE_argList = 23, 
		RULE_argument = 24, RULE_list = 25, RULE_elements = 26, RULE_listComp = 27, 
		RULE_dictionary = 28, RULE_dictEntry = 29;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "line", "importStmt", "importList", "importItem", "functionDecl", 
			"routeDecorator", "methodsParam", "paramList", "block", "statement", 
			"printStmt", "breakStmt", "continueStmt", "ifStmt", "condition", "forStmt", 
			"returnStmt", "assignment", "globalStmt", "expressionStmt", "expression", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"GLOBAL", "BREAK", "CONTINUE", "LBRACE", "RBRACE", "LPAREN", "RPAREN", 
			"LBRACKET", "RBRACKET", "COLON", "COMMA", "DOT", "AT", "ASSIGN", "EQUALS", 
			"NOT_EQUALS", "PLUS", "MINUS", "MUL", "DIV", "BLOCK_END", "ID", "INT", 
			"STRING", "BOOLEAN", "COMMENT", "WS"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2061862156974L) != 0)) {
				{
				{
				setState(60);
				line();
	...
	public final ImportItemContext importItem() throws RecognitionException {
		...
		try {
			...
			setState(87);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 137438968320L) != 0)) ) {
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2061593721388L) != 0)) {
				{
				{
				setState(137);
				statement();
	...
	public final GlobalStmtContext globalStmt() throws RecognitionException {
		...
		enterRule(_localctx, 38, RULE_globalStmt);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2061593229824L) != 0)) {
					{
					setState(210);
					argList();
					}
	...
	public final FlaskFuncContext flaskFunc() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_flaskFunc);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ListCompContext listComp() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_listComp);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final DictionaryContext dictionary() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_dictionary);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
