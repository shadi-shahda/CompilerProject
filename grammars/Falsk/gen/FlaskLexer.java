...
public class FlaskLexer extends Lexer {
	...
	public static final int
		NICE=1, WS=2, COMMENT=3, IDENTIFIER=4, ASSIGN_OP=5, COMMA=6, INTEGER_LITERAL=7;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"NICE", "WS", "COMMENT", "IDENTIFIER", "ASSIGN_OP", "COMMA", "INTEGER_LITERAL", 
			"NUM", "DIGIT"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "NICE", "WS", "COMMENT", "IDENTIFIER", "ASSIGN_OP", "COMMA", "INTEGER_LITERAL"
		};
	}
